        ...
        public async Task<UserInfo> Login(string username, string password)
        {
            try
            {
                if (Connectivity.Current.NetworkAccess == NetworkAccess.Internet)
                {
                    ...
                    //string url = "http://192.168.61.40:8009/api/UserInfoes/LoginUser"/"+username"/"+password";
                    string url = "http://192.168.1.107:8009/api/UserInfoes/LoginUser/" + username + "/" + password;
